  ...
  return (
    <main className="home-container">
      <div className="content-wrapper">
        <section id="intro" className="section-container mb-4 md:mb-6">
          <Intro />
        </section>
        <section id="projects" className="section-container mb-4 md:mb-6">
          <GitHubProjects />
        </section>
        <section id="blog" className="section-container mb-4 md:mb-6">
          <BlogPreview />
        </section>
